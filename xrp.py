...
def add_log(msg):
    ...
    if len(log_messages) > 10:  # keep last 10 for error display
        log_messages.pop(0)
...
def run_program(index):
    try:
        ...
        error_routine(f"Program {index} failed", f"Exception: {e}")
...
def main():
    ...
    menus = ["STRAIGHT", "ARC", "POINT", "SWING", "CIRCLE", "SQUARE", "POLYGON", "TEST", "SET LIMIT", "HLK-LD2450", "FOLLOW", "AVOID", "GO 5M", "IMU", "LOG"]
